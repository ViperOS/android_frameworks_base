...
public class HWKeysTile extends QSTile<QSTile.BooleanState> {
    ...
    protected void handleLongClick() {
        ...
        intent.setClassName("com.android.settings",
            "com.android.settings.Settings$VenomSettingsActivity");
    ...
    private void setEnabled(boolean enabled) {
        Settings.System.putInt(mContext.getContentResolver(),
                ...
                enabled ? 1 : 0);
        int defaultBrightness = mContext.getResources().getInteger(com.android.internal.R.integer.config_buttonBrightnessSettingDefault);
        try {
        ...
        CMSettings.Secure.putInt(mContext.getContentResolver(), CMSettings.Secure.BUTTON_BRIGHTNESS, enabled ? defaultBrightness : 0);
    }
