...
struct ResTable_config
{
  ...
  enum {
    ...
    enum {
        ...
        UI_MODE_NIGHT_YES_AMBAR = ACONFIGURATION_UI_MODE_NIGHT_YES_AMBAR << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_RED = ACONFIGURATION_UI_MODE_NIGHT_YES_RED << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_GREEN = ACONFIGURATION_UI_MODE_NIGHT_YES_GREEN << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_AQUA = ACONFIGURATION_UI_MODE_NIGHT_YES_AQUA << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_WHITE = ACONFIGURATION_UI_MODE_NIGHT_YES_WHITE << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITEPINK = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEPINK << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITEAMBAR = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEAMBAR << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITERED = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITERED << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITEGREEN = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEGREEN << SHIFT_UI_MODE_NIGHT,
