...
struct ResTable_config
{
  ...
  enum {
    ...
    enum {
        ...
        UI_MODE_NIGHT_YES_PINK = ACONFIGURATION_UI_MODE_NIGHT_YES_PINK << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_AMBER = ACONFIGURATION_UI_MODE_NIGHT_YES_AMBER << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_RED = ACONFIGURATION_UI_MODE_NIGHT_YES_RED << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_TEAL = ACONFIGURATION_UI_MODE_NIGHT_YES_TEAL << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_YES_AQUA = ACONFIGURATION_UI_MODE_NIGHT_YES_AQUA << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITEPINK = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEPINK << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITEAMBER = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEAMBER << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITERED = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITERED << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITETEAL = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITETEAL << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITEAQUA = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEAQUA << SHIFT_UI_MODE_NIGHT,

        UI_MODE_NIGHT_YES_PURPLE = ACONFIGURATION_UI_MODE_NIGHT_YES_PURPLE << SHIFT_UI_MODE_NIGHT,
        UI_MODE_NIGHT_NO_WHITEPURPLE = ACONFIGURATION_UI_MODE_NIGHT_NO_WHITEPURPLE << SHIFT_UI_MODE_NIGHT,
    };
